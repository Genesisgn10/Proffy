<p align="center">
   <h1 align="center" style="color: #8257E5;"> Proffy </h1>
</p>


<p align="center">	
   <a href="https://www.linkedin.com/in/genesisgn10/">
      <img alt="Gênesis Aquino" src="https://img.shields.io/badge/-GenesisAquino-8257E5?style=flat&logo=Linkedin&logoColor=white" />
   </a>
  <img alt="Repository size" src="https://repository-images.githubusercontent.com/284814831/8cae6a00-d769-11ea-998b-bdc878327c43">
...
<div align="center">
  <sub>The NLW #2 project. Built with ❤︎ by
    <a href="https://github.com/Genesisgn10">Gênesis Aquino</a> and
    <a href="https://github.com/Genesisgn10/proffy-react">
      contributors
    </a>
  </sub>
</div>
...
```bash
# Clone Repository
$ git clone https://github.com/Genesisgn10/proffy-react.git
```
### 📦 Run API
...
Feel free to **file a new issue** with a respective title and description on the the [Proffy](https://github.com/Genesisgn10/proffy-react) repository. If you already found a solution to your problem, **i would love to review your pull request**!
...
Made with love by [Gênesis Aquino](https://github.com/Genesisgn10) 🚀.
